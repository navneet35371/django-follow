...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Follow.target_posts'
        db.delete_column(u'follow_follow', 'target_posts_id')
    ...
    def backwards(self, orm):
        # Adding field 'Follow.target_posts'
        db.add_column(u'follow_follow', 'target_posts',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='follow_posts', null=True, to=orm['posts.Posts'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'articles.article': {
            ...
            'publish_up': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 29, 0, 0)'}),
        ...
        u'groups.group': {
            ...
            'country': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cities_light.Country']", 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'group_created_by'", 'to': u"orm['auth.User']"}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'group_updated_by'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'website': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
        u'groups.grouptopic': {
        ...
        u'jobs.job': {
            ...
            'publish_down': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 29, 0, 0)'}),
            'publish_up': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 29, 0, 0)'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'}),
            'state': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
        ...
        u'posts.post': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'post_created_by'", 'to': u"orm['auth.User']"}),
            ...
            'state': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'post_updated_by'", 'null': 'True', 'to': u"orm['auth.User']"})
        },
