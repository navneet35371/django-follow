...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'follow_follow', 'target_posts',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='follow_posts', null=True, to=orm['posts.Posts']),
                      keep_default=False)
    ...
    models = {
        ...
        u'follow.follow': {
            ...
            'target_posts': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'follow_posts'", 'null': 'True', 'to': u"orm['posts.Posts']"}),
